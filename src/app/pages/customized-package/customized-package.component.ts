...
@Component({
  selector: 'app-customized-package',
  templateUrl: './customized-package.component.html',
  styleUrl: './customized-package.component.css'
})
export class CustomizedPackageComponent {
