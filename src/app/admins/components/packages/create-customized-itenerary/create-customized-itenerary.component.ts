...
@Component({
  selector: 'app-create-customized-itenerary',
  templateUrl: './create-customized-itenerary.component.html',
  styleUrl: '../add-package/add-package.component.css',
...
export class CreateCustomizedIteneraryComponent implements OnInit { 
  ...
  "clientsPhoneNumber":this.clientsEmail,
  ...
  var {message,content} = await this.customizedPackage.addPackage(payload)
