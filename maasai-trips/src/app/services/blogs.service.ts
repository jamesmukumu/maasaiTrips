...
export class BlogsService {
  ...
  async createBlogCategory(blogCategory: any) {
    try {
      ...
      var response = await axios.post(
        `${this.baseUrl}/create/new/blog/category`,
        blogCategory,
        {
          headers: {
  ...
  async deleteBlog(id: number) {
    try {
      ...
      var response = await axios.delete(
        `${this.baseUrl}/delete/blog?id=${id}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  async publishBlog(id: number) {
    try {
      ...
      let response = await axios.patch(
        `${this.baseUrl}/publish/blog?id=${id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
  ...
  async unpublishBlog(id: number) {
    try {
      let token = Cookies.get('grant_token');
      let response = await axios.patch(
        `${this.baseUrl}/unpublish/blog?id=${id}`,
        {},
        {
          headers: {
            Authorization: `Bearer ${token}`,
